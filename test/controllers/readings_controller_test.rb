...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { animation: @reading.animation, code: @reading.code, question: @reading.question, title: @reading.title } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { animation: @reading.animation, code: @reading.code, question: @reading.question, title: @reading.title } }
